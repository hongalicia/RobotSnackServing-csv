...
def meta(config: ArgsConfig):
    ...
    ModifyInfoJson(metapath, num_data, num_videos, video_dir_names)
    ModifyModalityJson(metapath, video_dir_names)

def ModifyInfoJson(dir, num_data, num_videos, video_dir_names):
...
def ModifyModalityJson(dir, video_dir_names):
